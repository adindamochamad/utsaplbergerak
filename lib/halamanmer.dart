...
import 'package:utsmobapps/merreceipts1.dart';
import 'package:utsmobapps/merreceipts2.dart';

class HalamanMER extends StatefulWidget {
  const HalamanMER({super.key});

  @override
  State<HalamanMER> createState() => _HalamanMERState();
}

class _HalamanMERState extends State<HalamanMER> {
  final List<String> judulrute = <String>[
    "Kenpark to Gunung Anyar",
    "Gunung Anyar to Kenpark",
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Rute Kenpark Gununganyar"),
        ...
        children: [
          ...
          const Align(
            ...
            child: Padding(
              ...
              child: Text(
                "Rute MER tersedia 6 jam pemberangkatan",
                style: TextStyle(
                  color: Colors.grey,
                  fontSize: 18.0,
                ),
