...
import 'package:utsmobapps/tijreceipts1.dart';
import 'package:utsmobapps/tijreceipts2.dart';

class HalamanTIJ extends StatefulWidget {
  const HalamanTIJ({super.key});

  @override
  State<HalamanTIJ> createState() => _HalamanTIJState();
}

class _HalamanTIJState extends State<HalamanTIJ> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Rute UNESA Joyoboyo"),
        ...
        children: [
          ...
          const Align(
            ...
            child: Padding(
              ...
              child: Text(
                "Rute TIJ tersedia 6 jam pemberangkatan",
                style: TextStyle(
                  color: Colors.grey,
                  fontSize: 18.0,
                ),
